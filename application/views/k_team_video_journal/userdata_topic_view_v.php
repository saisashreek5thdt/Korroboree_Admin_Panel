                           ...
                           <div class="col-xl-6 xl-100">
                              <div class="card">
                                 <div class="job-search">
                                    <div class="card-body">
                                       <div class="media">
                                          <img class="img-40 img-fluid m-r-20" src="<?php base_url(); ?>assets/images/job-search/2.jpg" alt="">
                                          <div class="media-body">
                                             <h6 class="f-w-600">
												 <a href="<?php base_url(); ?>userdata_topic_view">Topic Name</a>
                           ...
                           <div class="col-xl-6 xl-100">
                              <div class="card">
                                 <div class="job-search">
                                    <div class="card-body">
                                       <div class="media">
                                          <img class="img-40 img-fluid m-r-20" src="<?php base_url(); ?>assets/images/job-search/4.jpg" alt="">
                                          <div class="media-body">
                                             <h6 class="f-w-600">
												 <a href="<?php base_url(); ?>userdata_topic_view">Topic Name</a>
