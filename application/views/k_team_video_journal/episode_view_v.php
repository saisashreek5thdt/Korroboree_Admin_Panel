                     ...
                     <div class="row">
                        ...
                        <div class="col-6">
                           <ol class="breadcrumb">
							  ...
							  <li class="breadcrumb-item">View Episode</li> 
                           </ol>
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="card">
                              <div class="card-body">
                                 <div class="product-slider owl-carousel owl-theme" id="sync1">
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/01.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/02.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/03.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/04.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/05.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/06.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/07.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>assets/images/ecommerce/08.jpg" alt=""></div>
                                 </div>
                        ...
                        <div class="col-xl-5 xl-100">
                           <div class="card">
                              <div class="card-body">
                                    ...
                                    <table class="product-page-width">
                                       <tbody>
                                          <tr>
                                             ...
                                             <td>Korroboree Team</td>
                                          </tr>
                                          <tr>
                                             <td> <b>Availability &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                                             <td class="txt-success">Live</td>
											 <td class="txt-danger">Created</td>
											 <td class="txt-primary">Work In Progress</td>
                                          </tr>
                                          <tr>
                                             <td> <b>Date Creation &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                                             <td>25 Jan, <span id="year"></span></td>
                                          </tr>
										  <tr>
                                             <td> <b>No of Topics &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                                             <td>25</td>
                                          </tr> 
                                          <tr>
                                             <td> <b>No of Activities &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                                             <td>87</td>
                                          </tr>
										  <tr>
                                             <td> <b>Theme Designed By &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                                             <td>5THDT Team</td>
                                          </tr> 
                                       </tbody>
                                    </table>
                                    ...
                                    <div class="col-md-6">
                                       <div class="product-icon">
                                          <ul class="product-social">
                                             ...
                                             <li class="d-inline-block"><a href="#"><i class="fas fa-rss"></i></a></li>
                                          </ul>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h6 class="product-title">Rating</h6>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="d-flex">
                                 ...
                                 <div class="m-t-15">
									...
									<a class="btn btn-secondary" href="<?php base_url(); ?>tracker_v"> <i class="fas fa-tv mr-1"></i>Tracker</a> 
                                 </div>
                              </div>
                           </div>
                        </div>
