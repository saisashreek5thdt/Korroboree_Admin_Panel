<?php include("includes/header.php");?>
    ...
    <div class="qustion_ans_video">
              ...
              <div>
                ...
                <div class="row exit_txt2">
                  <div class="col-lg-3 col-md-3">
                    <img src="<?php echo base_url() ?>frontassets/images/background/end_3.png" alt=""  class="left_side_img w-80">
                  </div>
      ...
      <div class="row">
        <div class="col mbl_icon" align="right">
          <span class="blinker "><img src="<?php echo base_url() ?>frontassets/images/icons/youtube_icon.png" alt="" data-toggle="tooltip" data-placement="bottom" title="Video content" class="right_side_icon ">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 rigt_se" align="right">
          <span class="blink_img "><img src="<?php echo base_url() ?>frontassets/images/icons/youtube_icon.png" alt="" data-toggle="tooltip" data-placement="bottom" title="Video content " class="right_side_icon youtube_top_right">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3">
          ...
          <div class="rotate_box">
            <img src="<?php echo base_url() ?>frontassets/images/gif/topic_3_1.gif" alt="" class="rotate_img">
          </div>
        ...
        <div class="col-lg-9 col-md-9 col-sm-9">
          ...
          <div class="next_btn_bg mt-30"  >
            
               <img src="<?php echo base_url() ?>frontassets/images/background/butn_bg.png" alt="" class="ntxt_btn sml_next_btn blob ">
                <div class="butn_txt ntxt_btn">
                  Next
                </div>
 ...
 <div class="widget">
  ...
  <div class="socials">
    <div class="phone">
      <a href="<?php echo base_url() ?>topics/index_2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
