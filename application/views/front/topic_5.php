  ...
  <body>
              ...
              <div>
                ...
                <div class="row exit_txt2">
                  <div class="col-lg-3 col-md-3">
                    <img src="<?php echo base_url() ?>frontassets/images/background/end_5.png" alt=""  class="left_side_img w-80">
                  </div>
    ...
    <div class="row">
      ...
      <div class="row" >
        ...
        <div class="" >
          <div class="col-md-2 col-sm-3 gif_text flot_r" >
            <div class="right_rect_bg">
              <img src="<?php echo base_url() ?>frontassets/images/gif/topic_5.gif" alt="" class="img-fluid animated_gif">
            </div>
           <!--  <div class="right_rect_text">
              Write your Interests and passion on the postcard
            </div> -->
          </div>
        </div>
	...
	<b>  NOTE : </b>Click on the same space to edit your answers.
            ...
            <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="let1()">Save </button>
	...
	<b>  NOTE : </b>Click on the same space to edit your answers.
            ...
            <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="let2()">Save </button>
            ...
            <div class="col-md-4 col-sm-6 envelope" style="margin-top: 10px;">
	...
	<b>  NOTE : </b>Click on the same space to edit your answers.
            ...
            <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="let3()">Save </button>
	...
	<b>  NOTE : </b>Click on the same space to edit your answers.
            ...
            <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="let4()">Save </button>
    ...
    <div id="myModal5" class="modal">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="border-bottom: none;">
            <img src="<?php echo base_url() ?>frontassets/images/background/koro_logo.png" alt="" class="w_ml_3_5" width="30%" style="margin-left: 35%;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
	...
	<b>  NOTE : </b>Click on the same space to edit your answers.
            ...
            <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="let5()">Save </button>
...
<!--           <div class="row">
 ...
 -->        </div>
      ...
      <div class="row" style="margin-top: 20px;">
        ...
        <div class="col-lg-5 col-md-5 " align="right">
          <img src="<?php echo base_url() ?>frontassets/images/gif/mailbox_gif--2.gif" alt="" class="mail_box_gif_btm" width="40%">
        </div>
      </div>
 ...
 <div class="widget">
  ...
  <div class="socials">
    ...
    <div class="email"><a href="<?php echo base_url() ?>/topics/topic_4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
        <i data-feather="chevrons-left" class="icons_btm_all" data-toggle="tooltip" data-placement="left" title="Previous"></i>
        </svg></a></div>
    <div class="instagram">
      <a href="<?php echo base_url() ?>topics/topic_6">
...
<script>
  ...
  <script>
    ...
    document.getElementById("letter1").src="<?php echo base_url() ?>frontassets/images/background/letter.png";  
  var x=  document.getElementById("text1").value;
    ...
    document.getElementById("letter1").src="<?php echo base_url() ?>frontassets/images/background/input_telegram.png";
    ...
    document.getElementById("letter2").src="<?php echo base_url() ?>frontassets/images/background/letter.png";
  var x=  document.getElementById("text2").value;
    ...
    document.getElementById("letter2").src="<?php echo base_url() ?>frontassets/images/background/input_telegram.png";
    ...
    document.getElementById("letter3").src="<?php echo base_url() ?>frontassets/images/background/letter.png";
  var x=  document.getElementById("text3").value;
    ...
    document.getElementById("letter3").src="<?php echo base_url() ?>frontassets/images/background/input_telegram.png";
    ...
    document.getElementById("letter4").src="<?php echo base_url() ?>frontassets/images/background/letter.png";
  var x=  document.getElementById("text4").value;
    ...
    document.getElementById("letter4").src="<?php echo base_url() ?>frontassets/images/background/input_telegram.png";
    ...
    document.getElementById("letter5").src="<?php echo base_url() ?>frontassets/images/background/letter.png";
  var x=  document.getElementById("text5").value;
    ...
    document.getElementById("letter5").src="<?php echo base_url() ?>frontassets/images/background/input_telegram.png";
    ...
    <script>
      $(document).ready(function() {
       $('.tp_5_sub').click(function() {
           window.location.href = "<?php echo base_url() ?>topics/topic_5_1";
       });
   });
    </script>
 ...
 <script>
  $(document).ready(function() {
     $('.img_next').click(function() {
         window.location.href = "<?php echo base_url() ?>topics/topic_6";
     });
 });
 $(document).ready(function() {
     $('.index_img').click(function() {
         window.location.href = "<?php echo base_url() ?>topics/topic_2";
     });
 });
</script>
  <script>
