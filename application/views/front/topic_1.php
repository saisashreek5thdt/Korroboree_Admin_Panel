<?php include("includes/header.php"); ?>
  <body>
    ...
    <div class="row">
      <div class="col" align="right">
        <span class="blinker mbl_icon"><img src="<?php echo base_url() ?>frontassets/images/icons/youtube_icon.png" alt="" data-toggle="tooltip" data-placement="bottom" title="Video content" class="right_side_icon ">
         
      </div>
    </div>
   
      <div class="row">
        <div class="col-lg-10 col-md-10 moon family_top_text why_top sml_scrn_txt"  >
         <span class="moonsht_inline"> Moonshot Conversations Episode 1: Foundation Session </span> 
        </div>
      ...
      <div class="row lights_top">
        <div class="col" align="center">
          <img src="<?php echo base_url() ?>frontassets/images/background/lights.png" alt="" class="lights lights_inline" >
        </div>
      </div>
      <div class="row">
        <div class="col" align="center">
 ...
 <!--        <video id="someID" width="450" height="auto" controls class="video_size vd sample_video" height="280">
          <source src="assets/images/video/youtube_video.mp4" type="video/mp4">
      ...
      <div class="row btm_chr_tp btm_chr_inline" >
        <div class="col" align="center">
          <img src="assets/images/background/videos.png" alt=""  class="botm_chirs btm_chr_img_inline">
        </div>
      </div>
 ...
 <div class="widget">
  ...
  <div class="socials">
    ...
    <div class="email"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
        <i data-feather="chevrons-left" class="icons_btm_all" data-toggle="tooltip" data-placement="left" title="Previous"></i>
        </svg></a></div>
    <div class="instagram">
      <a href="<?php echo base_url() ?>topics/topic_2">
