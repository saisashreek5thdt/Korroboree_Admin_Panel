...
<body>
             ...
             <div>
               ...
               <div class="row exit_txt2">
                 <div class="col-lg-3 col-md-3">
                   <img src="<?php echo base_url() ?>frontassets/images/background/end_1.png" alt=""  class="left_side_img w-80">
                 </div>
     ...
     <!-- popup end -->
         ...
         <div class="row">
            <div class="col-lg-10 col-md-10 moon family_top_text why_top "  >
               <span class="font_all" style="font-family:Segoe UI semibold">
                  ...
                  <font class="thumbnail-item color_t6" >
                     <i>contrarian</i>
                     <div class="tooltipz dis_none" >
                        <div class="out_top" >
                           <img src="<?php echo base_url() ?>frontassets/images/icons/icon_i.png" alt="" class="right_side_icon icon_out" >  
                           <p class="output" > people who see things differently	</p>
                        </div>
         ...
         <div class="row">
            <div class="col-lg-3 col-md-3 topic_6_mbl " style="margin-top: 100px;" align="center">
               <img src="<?php echo base_url() ?>frontassets/images/background/qustin.png" class="icanchnge_img" alt="" width="100%">
            </div>
            <div class="col-lg-9 col-md-9 " >
               ...
               <form action="<?php echo base_url();  ?>topics/topic_6_insert" method="post" >
                           ...
                           <div id="myModal" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    <div class="modal-header" style="border-bottom: none;" align="center">
                                       <img src="<?php echo base_url() ?>frontassets/images/background/koro_logo.png" alt=""  width="30%" style="margin-left: 35%;">
                                       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                       <span aria-hidden="true">&times;</span>
                                       </button>
                                    </div>
                                    <div class="modal-body" align="center">
                                       <textarea name ="topic1" id="s1" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       ...
                                       <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save1()">Save </button>
                  ...
                  <div class="row parent-text row_left ml-30_6" >
                     <div class="col" >
                           ...
                           <div id="myModal2" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea name ="topic2"  id="s2" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                                       ...
                                       <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save2()">Save </button>
                                       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div id="myModal3" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea name ="topic3" id="s3" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                           ...
                           <div id="myModal4" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea  name ="topic4" id="s4" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                           ...
                           <div id="myModal5" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea  name ="topic5" id="s5" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                                       ...
                                       <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save5()">Save </button>
                                       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div id="myModal6" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea  name ="topic6" id="s6" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                                       ...
                                       <button type="" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save6()">Save </button>
                                       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <!--  <div class="row parent-text" style="margin-left: 30%;">
                     <div class="col" >
                       <img src="assets/images/background/hungle.png" alt="" width="10%" style="float: left;" >
                       <div class="white_clr_inpt" id="demo7" onclick="myFunction7()"> 
                         <input type="text" placeholder="Type your text here" class="input_brdr">
                       </div>
                     </div>
                     </div> -->
                <!--     <div class="row parent-text add_row row_left ml-30_6_dis" >
                     <div class="col" >
                        <img src="assets/images/background/hungle.png" alt="" class="hungle_img" width="10%" style="float: left;" >
                        <div class="white_clr_inpt" id="demo8" >
                           <a href="#myModal7" class="submit_input_3" data-toggle="modal">
                           <input type="text" placeholder="" class="input_brdr tp_6_inpt" id="k7">
                           </a>
                           ...
                           <div id="myModal7" class="modal">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body" align="center">
                                       <textarea name="" id="s7" cols="60" rows="5" ></textarea>
                                    </div>
                                    <div class="modal-footer" style="border-top: none;">
                                       <center>
                                          <font style="color:#000; font-size:13px;font-family:Segoe UI semibold">
                                       ...
                                       <button type="button" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save7()">Save </button>
                                       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="row">
                     <div class="col add_btn_right" align="right" style="margin-right: 220px;">
                        <div class="add_more_bg "  >
                           <span class="add_4 add_6 add_box hide_6" id="add" onclick="dis()"> Add More</span>
                          </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col" align="center">
                         <img src="<?php echo base_url() ?>frontassets/images/background/butn_bg.png" alt="" class="  tpc_6_sub add_submit_an" style="margin-left: 10px;">
                         <div class="sub_6 tpc_6_sub">
                           <button type="submit" class=" btn-sm" data-dismiss="modal">submit</button>
                         </div>
                     </div>
                  </div>
                  </form>
 ...
 <div class="widget">
   ...
   <div class="socials">
     ...
     <div class="email"><a href="<?php echo base_url() ?>topics/topic_5"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
...
<script>
  feather.replace()
      ...
      <script>
         function chnge_img(){
                           document.getElementById('yellow_bulb') 
               .src="assets/images/background/yellow_bulb.png"; 
                           
                       }
         function chnge_img2(){
                           document.getElementById('yellow_bulb2') 
               .src="assets/images/background/yellow_bulb.png"; 
                           
                       }
         function chnge_img3(){
                           document.getElementById('yellow_bulb3') 
               .src="assets/images/background/yellow_bulb.png"; 
                           
                       }
         function chnge_img4(){
                           document.getElementById('yellow_bulb4') 
               .src="assets/images/background/yellow_bulb.png"; 
                           
                       }
         function chnge_img5(){
                           document.getElementById('yellow_bulb5') 
               .src="assets/images/background/yellow_bulb.png"; 
                           
                       }
         function chnge_img6(){
                           document.getElementById('yellow_bulb6') 
               .src="assets/images/background/yellow_bulb.png"; 
           ...
           <script>
            $(document).ready(function() {
               $('.img_next').click(function() {
                   window.location.href = "<?php echo base_url() ?>topics/topic_7";
               });
           });
           $(document).ready(function() {
	  ...
	  <script>
		  $(document).ready(function() {
			   $('.tpc_6_sub').click(function() {
                window.location.href = "<?php echo base_url() ?>topics/topic_6_1";
            });
		  });
	   </script>
      <script>
      ...
      <script type="text/javascript">
         ...
         $(document).ready(function () {
         		$('.thumbnail-item').mouseleave(function(e) {
      ...
      <script>
         ...
         document.getElementById("k1").value=a;
         
         }
         function save2(){
         var a=document.getElementById("s2").value;
         
         document.getElementById("k2").value=a;
         ...
         document.getElementById("k3").value=a;
         ...
         document.getElementById("k4").value=a;
         ...
         document.getElementById("k5").value=a;
         ...
         document.getElementById("k6").value=a;
         
         }
         function save7(){
         var a=document.getElementById("s7").value;
         
         document.getElementById("k7").value=a;
