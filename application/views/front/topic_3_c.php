...
<head> 
  ...
  <body>
    ...
    <!-- popup end -->
      ...
      <div class="row" >
        ...
        <form method="post" action= "<?php echo base_url() ?>topics/topic_3_insert"> 
          ...
          <div class="qustns_page">
            ...
            <div class="input_entry_thre">
              ...
              <input style="display:none;" data-toggle="modal" data-target="#exampleModal4" type="text" placeholder="" class="input_game_ans" name="otherAnswer" id="otherAnswer">
              </a>
            </div>

              <!-- Modal HTML -->
               <div id="myModal" class="modal">
                 <div class="modal-dialog dilog_inline">
          <div class="modal-content">
         <div class="modal-header" style="border-bottom: none;">
           <img src="<?php echo base_url() ?>frontassets/images/background/koro_logo.png" alt=""  class="mdl_inline"  >
          <button type="submit" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
         </div>
         <div class="modal-body" align="center">
           <textarea id="other_info" name="info" cols="60" rows="5" ></textarea>
         </div>
         <div class="modal-footer" style="border-top: none;">
          ...
          <button type="submit" class="btn btn-primary close_dumy_box" data-dismiss="modal" onclick="save()">Save </button>
          <button type="submit" class="btn btn-secondary close_dumy_box" data-dismiss="modal">Close</button>
          </div>
          </div>
         </div>   
         </div>
          </div>
          <div class="write write_inline" >
            <input type="image" src="<?php echo base_url() ?>frontassets/images/background/butn_bg.png" id="n1" class="write_box  tpc3_next add_submit_an" disabled>
            <div class="sub_3 ">
              <button type="submit"  data-dismiss="modal">Submit</button>
            </div>
            <!-- <img src="assets/images/background/butn_bg.png" alt="" class="write_box blob tpc3_next" >
            <div class="sub_3">
              Submit
            </div> -->
          </div>
 ...
 <div class="widget">
  ...
  <div class="socials">
    ...
    <div class="email"><a href="<?php echo base_url() ?>topics/topic_2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
        <i data-feather="chevrons-left" class="icons_btm_all" data-toggle="tooltip" data-placement="left" title="Previous"></i>
        </svg></a></div>
    <div class="instagram">
      <a href="<?php echo base_url() ?>topics/topic_4">
...
document.getElementById("n1").disabled = false;
  ...
  <script>
    ...
    $(document).ready(function() {
       $('.tpc3_next').click(function() {
           window.location.href = "<?php echo base_url() ?>topics/topic_3_4";
       });
   });
  </script>
<script>
